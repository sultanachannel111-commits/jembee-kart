...
const formSchema = z.object({
  ...
  shippingAddress: z
    .string()
    .min(5, { message: "Please enter a full shipping address." }),
});
    ...
    return (
      <Card className="bg-primary/5 border-primary/20">
        <CardHeader>
          ...
          <CardDescription>
            You need to be logged in as a customer to purchase this item.
          </CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Confirm your details to complete the purchase.
        </CardDescription>
      </CardHeader>
