...
<div className="min-h-screen bg-gray-100 pb-24">  <div className="max-w-xl mx-auto p-4">  {/* 🔥 OFFER BAR */}
{discount > 0 && (
...
<div className="bg-white rounded-xl p-3 space-y-3">  <h2 className="font-semibold">Select payment method</h2>  {/* COD */}
...
<div className="bg-white mt-4 p-3 rounded-xl space-y-2">  <h2 className="font-semibold">Delivery Details</h2>  <input
placeholder="Name"
