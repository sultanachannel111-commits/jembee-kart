...
<div className="bg-gradient-to-b from-pink-100 to-white min-h-screen pb-[80px]">  <Header />  <div className="pt-[80px] px-4 space-y-4">  <SearchBar  
search={search}  
setSearch={setSearch}  
...
<div className="bg-white rounded-xl shadow p-3">  <p className="text-sm font-semibold mb-2">  
🔥 Trending Searches  
</p>  <div className="flex flex-wrap gap-2">  {trendingSearch.map((item)=>(
<button
key={item}
