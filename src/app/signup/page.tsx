...
<button
type="submit"
className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 rounded-xl font-semibold hover:opacity-90"
>
...
className="text-pink-600 font-semibold cursor-pointer ml-1"
>
Login
</span>
